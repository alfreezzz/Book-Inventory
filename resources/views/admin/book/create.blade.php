            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="bg-blue-600 text-white px-6 py-4">
                    <h5 class="text-xl font-semibold flex items-center">
                        <i class="fas fa-plus mr-3"></i>Tambah Buku Baru
                    </h5>
                </div>
                <div class="p-6">
                    <form action="{{ route('books.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                       id="code" name="code" value="{{ old('code') }}" placeholder="Masukkan ID buku" required>
                                @error('code')
                            ...
                            <div>
                                ...
                                <select class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    ...
                                    <option value="Keilmuan" {{ old('category') == 'Keilmuan' ? 'selected' : '' }}>Keilmuan</option>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                   id="title" name="title" value="{{ old('title') }}" placeholder="Masukkan judul buku" required>
                            @error('title')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="number" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                       id="price" name="price" value="{{ old('price') }}" placeholder="Masukkan harga" min="0" step="100" required>
                                @error('price')
                                    <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                       id="stock" name="stock" value="{{ old('stock') }}" placeholder="Masukkan jumlah stok" min="0" required>
                                @error('stock')
                                    <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <select class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                ...
                                @empty
                                    <option value="">Tidak ada penerbit tersedia</option>
                                @endforelse
                            </select>
                            @error('publisher_id')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
