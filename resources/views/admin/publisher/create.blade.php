...
<head>
    ...
    <title>Tambah Penerbit - Admin Panel</title>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="bg-green-600 text-white px-6 py-4">
                    <h5 class="text-xl font-semibold flex items-center">
                        <i class="fas fa-plus mr-3"></i>Tambah Penerbit Baru
                    </h5>
                </div>
                <div class="p-6">
                    <form action="{{ route('publishers.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                       id="code" name="code" value="{{ old('code') }}" placeholder="Masukkan ID penerbit" required>
                                @error('code')
                            ...
                            <div>
                                ...
                                <input type="text" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                       id="phone" name="phone" value="{{ old('phone') }}" placeholder="Masukkan nomor telepon" required>
                                @error('phone')
                                    <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                   id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan nama penerbit" required>
                            @error('name')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                   id="city" name="city" value="{{ old('city') }}" placeholder="Masukkan kota" required>
                            @error('city')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                            <div class="mt-2">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                      id="address" name="address" rows="3" placeholder="Masukkan alamat lengkap" required>{{ old('address') }}</textarea>
                            @error('address')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="space-x-3">
                                ...
                                <button type="submit" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">
                                    <i class="fas fa-save mr-2"></i> Simpan Penerbit
                                </button>
                            </div>
                        </div>
                    </form>
